    ...
    info: {
        ...
        job: [
            ...
            desc: {
                ...
                actions: ['Выбрал стэк: React, React-Bootstrap, styled-components, TS, React-calendar.', 'Создавал компоненты TSX и прописывал логику для быстрого и безопасного взаимодействия с API', 'Взаимодействовал с REST API для получения и вывода данных на страницу, также для получения и отправки данных на сервер.', 'Работал с GIT в команде', 'Участвовал в ежедневных созвонах', 'Работали по AGILE SCRUM'],
            ...
            desc: {
                ...
                actions: ['Сверстал страницы на чистом HTML + CSS', 'Реализовал динамику страницы на нативном JavaScript', 'Переместил верстку в php файлы', 'Сотрудничал с коллегами, для гарантирования согласованности и стабильной работы системы'],
            ...
            desc: {
                ...
                actions: ['Разработал сайт на: Html + Css + Js + Bootstrap 5', 'Реализовал отправку формы на почту на языке PHP', 'Разместил сайт на хостинг', 'Занимался рекламой сайта на платформе Яндекс директ'],
