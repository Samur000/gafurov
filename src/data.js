    ...
    info: {
        ...
        job: [
            ...
            desc: {
                ...
                actions: [
                    'Разработка Frontend части на React, TypeScript',
                    'Стилизация на React-Bootstrap , Styled-Components',
                    'Работа с библиотекой React-Calendar',
                    'Активное участие в проектировании и разработке архитектуры клиентской части;',
                    'Разработка новых фич, а также улучшение и оптимизация существующего кода',],
            ...
            durationMonth: '3 месяца',
            desc: {
                situation: 'нужен интерфейс сайта для взаимодействия с API',
                task: 'сверстать страницы кроссбраузерно и адаптивно с динамикой',
                actions: [
                    'Участие в верстке страниц на Html , Css',
                    'Реализация динамики сайта на JavaScript',
                    'Перемещение верстки в php файлы',
                    'Активное участие в проектировании и разработке архитектуры клиентской части',
                    ],
            ...
            desc: {
                ...
                actions: [
                    'Разработка полноценного многостраничного сайта: Html, Css , JavaScript , Bootstrap 5 , jQuery',
                    'Реализация отправки формы на почту на языке PHP',
                    'Деплой сайта на хостинг и получение сертификата для HTTPS соединения',
                    'SEO оптимизация сайта и продвижение на Яндекс директ',
                ],
